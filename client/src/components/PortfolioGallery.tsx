...
const works: WorkItem[] = [
  {
    id: "1",
    title: "any1willtellyathefaxuneed2knowlikehowurpictureframeisliketheaxloftheglobe",
    description: "Latest experimental transmission",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=cN74jrPOKmE",
    color: "primary",
  },
  {
    id: "2",
    title: "smoking blvnts",
    description: "3m 50s smooth atmospheric mix for late-night vibes",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=0wxbt3Rkiks",
    color: "accent",
  },
  {
    id: "3",
    title: "D.D.T.S. 2: ADVENTURES IN SPECTACLE",
    description: "58m MKULTRADEPROGRAMMIX experimental audio-visual experience",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=LtXABR6BIls",
    color: "secondary",
  },
  {
    id: "4",
    ...
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=UfwzwTMAaf4",
    color: "primary",
  },
  {
    id: "5",
    title: "in the event that everything should go terribly wrong",
    description: "be grateful you're still here",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=ImUSYuVg1Xc",
    color: "accent",
  },
  {
    id: "6",
    title: "fire selecta heart",
    description: "Curated selection of fire tracks for the soul",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=MB4bWoq6BZU",
    color: "secondary",
  },
  {
    id: "7",
    title: "Larry Gunslinger's XXX Birthday Mixdown",
    description: "Special birthday celebration mix",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=X79hlLpMQxA",
    color: "primary",
  },
  {
    id: "8",
    title: "we dont call the cops beats",
    description: "Anti-authoritarian sonic statement",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=R5VumwmRp_4",
    color: "accent",
  },
  {
    id: "9",
    ...
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=BfJTxcqfPLY",
    color: "secondary",
  },
  {
    id: "10",
    ...
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=mJgwrOru1Xw",
    color: "primary",
  },
  {
    id: "11",
    title: "EC²W² 2: Terrordome",
    description: "Intense sonic warfare experience",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=MpgT8D5P8iA",
    color: "accent",
  },
  {
    id: "12",
    title: "Winter Antifascist Wonderland",
    description: "Seasonal resistance soundtrack",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=0QlFi-fQbVk",
    color: "secondary",
  },
  {
    id: "13",
    title: "its late; you cant keep blowin up her phone like this",
    description: "Mix for late night rumination",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=PuzNGGEaS1Y",
    color: "primary",
  },
  {
    id: "14",
    title: "new year new mix high strangeness",
    description: "New year sonic exploration",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=YgXl5vIZN-Q",
    color: "accent",
  },
  {
    id: "15",
    title: "Oh my DAYS, oh my goshhh...",
    description: "Don't listen to fools on the 12th day of CRIMMUS",
    category: "AUDIO_MIX",
    link: "https://www.youtube.com/watch?v=Y3wIs5OxJj4",
    color: "secondary",
  },
];
